...
theme_file="$proj_home/.oh-my-bash/themes/brunurd/brunurd.theme.sh"
...
test -d "$HOME/.oh-my-bash/themes/brunurd" || mkdir -p "$HOME/.oh-my-bash/themes/brunurd"
...
cp -v $theme_file "$HOME/.oh-my-bash/themes/brunurd/brunurd.theme.sh"
